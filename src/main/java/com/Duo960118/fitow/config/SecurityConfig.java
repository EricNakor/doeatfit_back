...
//    }
    ...
    String[] noAuthGet = {"/", "/login", "/find/**", "/join", "/notices", "/api/email/verify", "/api/user/check/**", "api/notices", "api/notices/{id}","api/workouts/**","workouts/**"};
    String[] noAuth = {"api/user/find/**", "/api/user/send-temp-passwd", "/api/user/join", "/api/email/send/auth","api/workouts/**","api/workouts/{uuid}"};
